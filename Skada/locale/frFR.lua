...
L["Class icons"] = "Icônes de classe" -- Needs review
...
L["Disables mouse clicks on bars."] = "Désactive les clics de souris sur les barres." -- Needs review
...
L["TPS"] = "MPS"
L["Use class icons where applicable."] = "Utilise les icônes de classe quand cela est pertinent." -- Needs review
