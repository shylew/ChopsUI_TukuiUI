...
L["Buff spell list"] = "Liste des techniques d'amélioration" -- Needs review
L["Buff uptimes"] = "Temps d'activité des améliorations" -- Needs review
L["Buttons"] = "Boutons"
L["CC"] = "CC"
...
L["Hit"] = "Touche"
L["Ignore Main Tanks"] = "Ignorer tanks principaux" -- Needs review
L["Immune"] = "Insensible"
...
L["Shows numbers for relative ranks for modes where it is applicable."] = "Affiche les numéros des rangs relatifs pour les modes où cela est applicable." -- Needs review
...
L["Shows threat on focus target, or focus target's target, when available."] = "Affiche la menace envers la cible de la focalisation ou la cible de la cible de la focalisation le cas échéant. " -- Needs review
...
L["Use focus target"] = "Utiliser cible de la focal." -- Needs review
