...
L["Aggressive combat detection"] = "Агрессивное определение режима боя" -- Needs review
...
L["Ask"] = "Уточнить"
L["Attack"] = "Атака"
L["Automatically switch to set 'Current' and this mode after a wipe."] = "Автоматически переключиться в этот режим и \"Текущий бой\" после вайпа." -- Needs review
...
L["Buff spell list"] = "Список бафов" -- Needs review
L["Buff uptimes"] = "Время действия бафов" -- Needs review
...
L["Click for"] = "Клик -"
L["Clickthrough"] = "Клик насквозь" -- Needs review
L["Columns"] = "Колонки"
...
L["Merge pets"] = "Объединять питомцев" -- Needs review
L["Merges pets with their owners. Changing this only affects new data."] = "Считать урон от атак питомцев вместе с их хозяевами. Изменение опции повлияет только на новые данные." -- Needs review
...
L["Sets the scale of the window."] = "Установка масштаба окна" -- Needs review
...
L["Show totals"] = "Показывать итог" -- Needs review
...
L["Shows a extra row with a summary in certain modes."] = "Отображение дополнительной строки с суммарной информацией в некоторых режимах." -- Needs review
...
L["Snap to best fit"] = "Притягивание размера" -- Needs review
L["Snaps the window size to best fit when resizing."] = "Размер окна автоматически подстраивается для лучшего отображения информации." -- Needs review
...
L["There is nothing to report."] = "Нет данных для отчета." -- Needs review
-- L["Thick outline"] = ""
...
L["Windows"] = "Окна"
L["Wipe mode"] = "При вайпе" -- Needs review
L["Yes"] = "Да"
