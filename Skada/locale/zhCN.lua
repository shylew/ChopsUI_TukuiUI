...
L["'s Buffs"] = "的 Buff"
L["'s Damage"] = "的伤害"
L["'s Damage taken"] = "受到的伤害" -- Needs review
L["'s Death"] = "的死亡"
L["'s Debuffs"] = "的减益效果"
L["'s Fails"] = "的失误"
L["'s Healing"] = "的治疗"
...
L["Buff spell list"] = "Buff 法术列表"
L["Buff uptimes"] = "Buff 覆盖时间"
L["Buttons"] = "按钮"
L["CC"] = "控场技能"
...
L["Skada report on %s for %s, %s to %s:"] = "Skada战斗报告：%s的%s, %s到%s:"
