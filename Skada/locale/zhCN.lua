...
L["Healing taken"] = "获得治疗" -- Needs review
L["Health"] = "生命"
...
L["Max bars"] = "最大条数量"
L["Maximum hit:"] = "最大伤害:"
L["Merge pets"] = "合并宠物" -- Needs review
L["Merges pets with their owners. Changing this only affects new data."] = "合并宠物和宠物主任的数据. 改动这个将仅影响到新的数据。" -- Needs review
L["Minimum hit:"] = "最小伤害:"
L["Missed"] = "未命中"
L["Mode"] = "模式"
...
L["Show totals"] = "显示总共" -- Needs review
...
L["There is nothing to report."] = "没有要报告的内容。" -- Needs review
