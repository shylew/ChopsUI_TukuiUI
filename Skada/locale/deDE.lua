...
L["Merge pets"] = "Begleiter zusammenfügen" -- Needs review
L["Merges pets with their owners. Changing this only affects new data."] = "Fügt Begleiter mit ihren Besitzern zusammen. Eine Änderung hier wirkt sich nur auf neue Daten aus." -- Needs review
...
L["There is nothing to report."] = "Es gibt nichts zu berichten." -- Needs review
