...
L["Choose the background color of the bars."] = "選擇橫條的背景顏色"
...
L["Maximum hit:"] = "最大值:"
L["Merge pets"] = "合併寵物"
L["Merges pets with their owners. Changing this only affects new data."] = "合併寵物與主人，改變只影響新的數據。"
L["Minimum hit:"] = "最小值:"
L["Missed"] = "未擊中"
L["Mode"] = "模組"
...
L["Shows a extra row with a summary in certain modes."] = "在某些模式，顯示一個總結在額外的行。"
...
L["Snap to best fit"] = "對齊到最合適"
L["Snaps the window size to best fit when resizing."] = "當視窗調整大小時對齊到最合適。"
...
L["There is nothing to report."] = "沒有東西可以報告。"
-- L["Thick outline"] = ""
