...
L["Adjust the width of each unit's frame."] = "Modifie la longueur utilisée par chaque cellule d'unité."
L["Always"] = "Toujours"
-- L["Bar Options"] = ""
L["Border"] = "Bordure"
L["Border Size"] = "Taille des bords"
...
L["Icon Border Size"] = "Taille de la bordure de l'icône centrale"
L["Icon Cooldown Frame"] = "Texte du temps de recharge sur l'icône"
-- L["Icon Options"] = ""
L["Icon Size"] = "Taille de l'icône centrale"
...
L["Center"] = "Centre"
L["Choose the layout border texture."] = "Détermine la disposition de la texture de la bordure"
...
L["Colors"] = "Couleurs"
L["Creature type colors"] = "Types de créatures"
L["Demon"] = "Démon"
...
L["Top"] = "Haut"
L["Top Left"] = "Hautgauche"
L["Top Right"] = "Hautdroite"
...
L["Range filter for %s"] = "Affiche uniquement %s si l'unité est à portée."
...
L["Color for Aggro."] = "La couleur à utiliser pour l'aggro."
L["Color for High Threat."] = "La couleur à utiliser pour la menace haute."
L["Color for Tanking."] = "La couleur à utiliser pour les tanks."
L["High"] = "Haut"
