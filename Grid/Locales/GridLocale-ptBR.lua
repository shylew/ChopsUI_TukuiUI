...
L["Right-Click to open the options menu."] = "Clique-direito para abrir as opções de menu."
...
L["Show more detailed threat levels."] = "Mostra níveis de ameaça mais detalhadamente."
L["Tank"] = "Tanque"
...
L["Add new Buff"] = "Adicionar novo buff"
L["Add new Debuff"] = "Adicionar novo debuff"
L["Adds a new buff to the status module"] = "Adicionar novo buff ao módulo de status"
L["Adds a new debuff to the status module"] = "Adiciona um novo debuff ao módulo de status "
L["Auras"] = "Auras"
...
L["Delete (De)buff"] = "Excluir (De)buff"
L["Deletes an existing debuff from the status module"] = "Exclui um debuff existente do módulo de status"
L["Disease"] = "Doença"
