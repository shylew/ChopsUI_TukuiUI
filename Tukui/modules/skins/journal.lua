...
local function LoadSkin()
	...
	-- /script EncounterJournalInstanceSelectScrollFrameScrollChildInstanceButton1:SetTemplate()
	...
	--EncounterJournalInstanceSelectDungeonTab:SetPoint("LEFT", EncounterJournalInstanceSelectScrollDownButton, "RIGHT", 10, 0)
	--EncounterJournalInstanceSelectRaidTab:ClearAllPoints()
	--EncounterJournalInstanceSelectRaidTab:SetPoint("LEFT", EncounterJournalInstanceSelectDungeonTab, "RIGHT", 10, 0)
