...
GridStatusRaidDebuff:Debuff(zone, 80161, 23, 5, 5) --Chemical Cloud
GridStatusRaidDebuff:Debuff(zone, 80011, 24, 5, 5) --Soaked in Poison
...
GridStatusRaidDebuff:Debuff(zone, 82881, 37, 7, 7) --Break
