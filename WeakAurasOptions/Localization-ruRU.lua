...
L["Align"] = "Выровнять"
L["Allow Full Rotation"] = "Задать Полное Вращение"
...
L["Choose whether the displayed icon is automatic or defined manually"] = "Выберите, будет ли значок отображаться автоматически или вручную"
...
L["Collapse all non-loaded displays"] = "Свернуть все не активные индикации"
L["Color"] = "Цвет"
L["Compress"] = "Сжать"
...
L["Expansion is disabled because this group has no children"] = "Развертывание не возможно, по тому что группа не имеет элементов"
...
L["Progress Texture"] = "Прогресивная Текстура"
...
L["Right-click for more options"] = "Правый клик для больших опций"
...
L["Tooltip"] = "Подсказка"
L["Tooltip on Mouseover"] = "Подсказка при наведение мыши"
...
L["Unit Exists"] = "Цель Не Существует"
