...
L["Play Sound"] = "Geräuch abspielen"
L["Presence (DK)"] = "Präsenz (Todesritter)"
L["Presence (Rogue)"] = "Präsenz (Schurke)"
L["Prevents duration information from decreasing when an aura refreshes. May cause problems if used with multiple auras with different durations."] = "Verhintert, dass die Dauer der Aura sich verringert beim erneuern. Kann zu Problemen bei mehreren Auren führen!"
L["Primary"] = "Erste"
