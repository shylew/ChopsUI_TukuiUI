...
L["Profiles"] = "Профили"
L.introduction = "Добро пожаловать в Big Wigs, где бродят боссы. Пожалуйста, пристегните ремни безопасности, ешьте арахис и наслаждайтесь поездкой. Он не будет есть ваших детей, зато поможет вам подготовиться к встречи с новыми боссами, словно ужин из 7 блюд для вашего рейда.\n"
...
L.raidiconDesc = "Некоторые скрипты событий используют метки рейда, чтобы помечать игроков, которые представляют особый интерес для вашей группы. К примеру 'бомба'-тип эффекта и контроль разума.\n\n|cffff4411Применимо, если вы Лидер группы/рейда!|r"
...
L["PROXIMITY_desc"] = "Способности иногда требуют от вас рассредоточиться. Отображение близости будет специально показываться для таких спобностей, так что вы сможете сказать с одного взгляда в безопасности вы или нет."
