...
function Ellipsis:SampleTimers()
	...
	for x = 1, 3 do
		self:CreateTimer('sample' .. x, format(L.SampleTimer, 1), nil, 'Interface\\Icons\\Ability_Seal', 0, 30, time + 30, time)
		self:CreateTimer('sample' .. x, format(L.SampleTimer, 2), nil, 'Interface\\Icons\\Ability_Seal', 0, 30, time + 29.8, time)
		self:CreateTimer('sample' .. x, format(L.SampleTimer, 3), nil, 'Interface\\Icons\\Ability_Seal', 0, 30, time + 29.6, time)
		self:CreateTimer('sample' .. x, format(L.SampleTimer, 4), nil, 'Interface\\Icons\\Ability_Seal', 0, 30, time + 29.4, time)
	end
...
function Ellipsis:GetOptionFonts()
	local fonts = {}
...
function Ellipsis:GetOptionTextures()
	local textures = {}

	for k in pairs(Media:HashTable('statusbar')) do
		textures[k] = k
	end
...
function Ellipsis:GetSoundOptionValues()
	local sounds = {}

	for k in pairs(Media:HashTable('sound')) do
		sounds[k] = k
	end
