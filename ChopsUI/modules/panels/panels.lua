...
chatTabPanel:SetPoint("BOTTOMLEFT", TukuiInfoLeft, "TOPLEFT", 0, 131)
...
TukuiInfoLeftLineVertical:SetHeight(154)
TukuiInfoRightLineVertical:SetHeight(154)
...
TukuiBar1:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, 127)
TukuiBar1:SetPoint("LEFT", UIParent, "LEFT", 414, 0)
TukuiBar1:SetWidth((T.buttonsize * 6) + (T.buttonspacing * 7))
TukuiBar1:SetHeight((T.buttonsize * 2) + (T.buttonspacing * 3))

-- Move the second action bar below the primary action bar instead of to the
-- left.
TukuiBar2:ClearAllPoints()
TukuiBar2:SetPoint("TOPLEFT", TukuiBar1, "BOTTOMLEFT", 0, -12)

-- Move the third action bar below the fourth action bar instead of to the
-- right.
TukuiBar3:ClearAllPoints()
TukuiBar3:SetPoint("TOPLEFT", TukuiBar4, "BOTTOMLEFT", 0, -12)
...
TukuiBar4:SetPoint("BOTTOM", UIParent, "BOTTOM", 0, 127)
TukuiBar4:SetPoint("RIGHT", UIParent, "RIGHT", -414, 0)
